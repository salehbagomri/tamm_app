...
import '../../features/customer/profile/presentation/my_favorites_screen.dart';
...
import '../../features/technician/earnings/presentation/tech_earnings_screen.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (_, __) => const MyFavoritesScreen(),
      ),
