...
class _ServiceRequestScreenState extends ConsumerState<ServiceRequestScreen> {
  ...
  Future<void> _submit(ServiceType service) async {
  ...
  Widget _buildCurrentStep(ServiceType service) {
    return switch (_currentStep) {
      0 => _buildLocationStep(),
      1 => _buildAppointmentStep(),
      2 => _buildPaymentStep(),
      3 => _buildConfirmStep(service),
  ...
  Widget _buildAppointmentStep() {
    final confirmed = _selectedDate != null && _selectedPeriod != null;
    ...
    return Column(
      ...
      children: [
        ...
        PaymentMethodSelector(
          ...
          onChanged: (type, methodId) => setState(() {
            _paymentType = type;
  ...
  Widget _buildConfirmStep(ServiceType service) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        AppSpacing.gapMd,
        TammTextField(
          ...
          hint: 'أي تفاصيل إضافية تساعد الفني (اختياري)',
  ...
  Widget _buildServiceSummary(ServiceType service) {
    String paymentLabel() {
      if (_paymentType == 'cash') return 'كاش عند الاستلام';
      if (_paymentType == 'bank') return 'تحويل بنكي';
      ...
      child: Column(
        ...
        children: [
          ...
          _SummaryRow(
            ...
            label: _addressCtrl.text.trim(),
          ),
          if (dateStr.isNotEmpty) ...[
            AppSpacing.gapSm,
            _SummaryRow(
              icon: Icons.calendar_today_outlined,
              label: '$dateStr — ${_selectedPeriod ?? ''}',
            ),
          ],
          AppSpacing.gapSm,
          _SummaryRow(
  ...
  Widget _buildNavigationBar(ServiceType service) {
            ...
            children: [
              ...
              Expanded(
                ...
                child: TammButton(
                  ...
                  isLoading: _loading,
                  onPressed: isLastStep ? () => _submit(service) : _nextStep,
                ),
              ),
            ],
          ),
